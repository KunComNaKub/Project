...
--
-- Host: localhost
-- Generation Time: Mar 06, 2023 at 04:41 AM
...
(13, 60, 'นาย', 'หมายเลขหนึ่ง', 'หนึ่ง', 'บริหารธุรกิจและเทคโนโลยีสารสนเทศ', 'วิทยาการสารสนเทศ', 1102002020, 'ภาคปกติ', 2556, 2147483647, 'testtestmail@gmail.com', 'images.jpg', 1, 1, 'ปริญญาตรี'),
...
(19, 66, 'นาย', 'หมายเลขเจ็ด', 'เจ็ด', 'ศิลปะศาสตร์', 'การตลาด', NULL, 'ภาคสมทบ', 2556, 0, '', NULL, 3, 1, 'ปริญญาตรี'),
(20, 69, 'นางสาว', 'หมายเลขสาม', 'สาม', 'บริหารธุรกิจและเทคโนโลยีสารสนเทศ', 'วิทยาการสารสนเทศ', NULL, 'ภาคปกติ', 2556, NULL, NULL, 'images.jpg', 2, 1, 'ปวส'),
...
CREATE TABLE `transfer_std` (
  ...
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '-'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `transfer_std` (`id`, `Student_id`, `Subjecttrans_id`, `Subject_idtran`, `Subject_nametran`, `Credit_tran`, `Gpa_tran`, `Year_tran`, `Teacher_pass`, `remark`) VALUES
(100, 19, 13, '01-220-001', 'จิตวิทยาทั่วไป', 3, 3.5, 2556, 'ไม่ผ่าน', 'ฟหก'),
(101, 19, 14, '01-320-101', 'ภาษาอังกฤษ 1', 3, 3.5, 2556, 'ผ่าน', ''),
(102, 19, 15, '01-320-102', 'ภาษาอังกฤษ 2', 3, 2.5, 2556, 'ผ่าน', ''),
...
(106, 13, 23, '05-052-204', 'การประยุกต์ใช้อินเตอร์เน็ตและอินทราเน็ต', 3, 3.5, 2556, 'ผ่าน', ''),
(107, 13, 10, '01-220-001', 'จิตวิทยาทั่วไป', 3, 3.5, 2556, 'พิจารณา', ''),
(108, 13, 14, '01-320-101', 'ภาษาอังกฤษ 1', 3, 3.5, 2556, 'พิจารณา', ''),
(109, 13, 15, '01-320-102', 'ภาษาอังกฤษ 2', 3, 2.5, 2556, 'ผ่าน', '');
