                ...
                <div class="box_transfer_social">
                    ...
                    <div class="box_transfer_subject_1">
                        ...
                        <tr>
                            ...
                            <?php 
                            $sql = "SELECT * FROM subject left JOIN (SELECT * FROM transfer_std WHERE Student_id = $Student_id ) as transfer_std on subject.Subject_id = transfer_std.Subjecttrans_id WHERE Group_Category = 'กลุ่มสังคมศาสตร์และมนุษย์ศาสตร์'  ";
                            $result = $connect->query($sql);
                ...
                <div class="box_transfer_language">
                    ...
                    <table>
                        <tr>
                            ...
                            <?php 
                            $sql = "SELECT * FROM subject left JOIN (SELECT * FROM transfer_std WHERE Student_id = $Student_id ) as transfer_std on subject.Subject_id = transfer_std.Subjecttrans_id WHERE Group_Category = 'กลุ่มภาษา'  ";
                            $result = $connect->query($sql);
                            while ($row = $result ->fetch_assoc()):
                             ?>
                            <tr>
